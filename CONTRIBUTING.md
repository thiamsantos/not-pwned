...
## Reporting Issues
Found a problem? Want a new feature? First of all see if your issue or idea has [already been reported](https://github.com/thiamsantos/not-pwned/issues).
If don't, just open a [new clear and descriptive issue](https://github.com/thiamsantos/not-pwned/issues/new).
...
- Fork it!
- Clone your fork: `git clone https://github.com/<your-username>/not-pwned`
- Navigate to the newly cloned directory: `cd not-pwned`
